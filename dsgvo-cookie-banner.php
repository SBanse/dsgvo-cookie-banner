 ...
 * Description: Datenschutzkonformer Cookie-Banner nach europäischem Standard (DSGVO/GDPR) mit Cookie-Scanner, Inline-Bearbeitung und Mehrsprachigkeit (DE/EN).
 * Version:     1.1.0
 * Author:      sbanse
 * License:     GPL-2.0+
...
// i18n so früh wie möglich initialisieren
